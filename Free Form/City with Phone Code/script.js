window.onload = function () {
  fetch(
    "https://cdn.jsdelivr.net/npm/country-code-flag-phone-extension-json@1.0.2/dist/index.json"
  )
...
paymentButton.addEventListener("click", async (e) => {
  ...
  if (!isValidCity(formData.city)) {
    const cityError = getInput("cityError");
  ...
  if (isValid) {
    ...
    try {
      ...
      window.open(`https://workshop.catapan.in/typage`, "_blank");
    } catch (error) {
