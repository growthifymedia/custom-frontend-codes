...
const form = document.getElementById("b-lead-form");
const submitButton = document.getElementById("b-submit-btn");
...
submitButton.addEventListener("click", async (e) => {
  ...
  if (!formData.name) {
    showError("b-name", "b-name-error");
    isValid = false;
  }

  if (!isValidEmail(formData.email)) {
    showError("b-email", "b-email-error");
    isValid = false;
  }

  if (!isValidPhone(formData.phone)) {
    showError("b-phone", "b-phone-error");
    isValid = false;
  }
