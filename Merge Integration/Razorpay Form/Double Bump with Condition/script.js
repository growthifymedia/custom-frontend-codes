...
const config = {
  ...
  const updateAmount = () => {
    ...
    elements.paymentButton.disabled = newAmount === 0;
    elements.paymentButton.style.opacity = newAmount === 0 ? 0.7 : 1;
    elements.amountValue.innerText = newAmount === 0 ? "" :  `₹${newAmount}.00`;
    elements.totalAmountValue.innerText =  newAmount === 0 ? "" :`₹${newAmount}.00`;
    elements.paymentButton.innerText = newAmount === 0 ? "Pay" : `Pay ₹${newAmount}`;
    return newAmount;
  };
