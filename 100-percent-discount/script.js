...
const discountCheckbox = document.getElementById("discount100");
...
discountCheckbox.addEventListener("change", function () {
  if (discountCheckbox.checked) {
    amount = 0;
    document.getElementsByClassName("amount")[0].innerText = `₹0.00`;
    document.getElementsByClassName("total-amount")[0].innerText = `₹0.00`;
    paymentButton.innerText = `Pay ₹0`;
  } else {
    amount = 9;
    document.getElementsByClassName("amount")[0].innerText = `₹9.00`;
    document.getElementsByClassName("total-amount")[0].innerText = `₹9.00`;
    paymentButton.innerText = `Pay ₹9`;
  }
});
...
paymentButton.addEventListener("click", async (e) => {
  ...
  if (isValid) {
    ...
    if (amount === 0) {
      ...
      try {
        await fetch(formSubmissionWebhook, {
          method: "POST",
